        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 relative">
          <div className="max-w-2xl">
            ...
            <h1 className="text-5xl font-bold leading-tight mb-6">
              Вкус Таиланда —<br />
              <span className="text-yellow-300">в вашем доме</span>
            </h1>
            <p className="text-amber-100 text-lg mb-8 leading-relaxed">
              Аутентичные продукты, специи и соусы напрямую из Таиланда.
              Никаких посредников — только настоящий тайский вкус.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="grid grid-cols-3 gap-6 text-center">
            ...
            <div>
              ...
              <div className="text-amber-200 text-sm mt-1">довольных клиентов</div>
            </div>
            <div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
          {categories.slice(1).map((cat) => (
            ...
            >
              ...
              <div className="text-sm font-medium text-gray-700 group-hover:text-amber-700 transition-colors">
                {cat.name}
              </div>
            </Link>
          ))}
      ...
      <section className="bg-gradient-to-r from-green-800 to-green-600 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
          ...
          <p className="text-green-100 mb-8 max-w-md mx-auto">
            Доставляем по всей России. Все товары прошли таможенный контроль и сертифицированы.
          </p>
          <Link
            href="/products"
            className="bg-white text-green-800 font-semibold px-8 py-3 rounded-full hover:bg-green-50 transition-colors inline-block"
          >
            Начать покупки
          </Link>
        </div>
